      ...
      <div className="flex-1 flex flex-col items-center justify-center relative z-10">
        ...
        <Card className="w-full max-w-md shadow-2xl border-white/20 bg-white/95 backdrop-blur-xl rounded-3xl animate-in fade-in slide-in-from-bottom-8 duration-700">
          <CardHeader className="text-center space-y-3 pb-8 pt-10">
            <CardTitle className="text-3xl font-bold text-slate-800 tracking-tight">Welcome back</CardTitle>
            <p className="text-slate-500 font-medium">Enter your credentials to access the admin dashboard.</p>
          </CardHeader>
            ...
            <form className="space-y-5">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between ml-1">
                  ...
                  <Link href="#" className="text-xs font-semibold text-purple-600 hover:text-purple-700">Forgot password?</Link>
                </div>
                <input 
                  type="password" 
                  name="password"
              ...
              <div className="pt-6">
                <button 
                  formAction={login}
                  className="group relative w-full flex justify-center items-center gap-2 py-4 px-4 border border-transparent text-sm font-bold rounded-xl text-white bg-slate-900 hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-900 transition-all shadow-lg hover:shadow-xl"
                >
                  Sign In
